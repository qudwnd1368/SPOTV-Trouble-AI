...
.sidebar-logo-link{display:block;margin:0 auto .7rem}.sidebar-logo-link img{display:block;width:100%;height:auto}.sidebar-brand-link{display:block;color:var(--text)!important;text-decoration:none!important;font-size:1.17rem;font-weight:800;margin:.2rem 0}.sidebar-subtitle{color:var(--muted);font-size:.8rem;letter-spacing:-.025em;line-height:1.4;white-space:nowrap}
